...
![image-20200705081813409](https://cdn.jsdelivr.net/gh/senluoye/BadGallery@main/image/202203181937682.png)
...
![image-20200705084038680](https://cdn.jsdelivr.net/gh/senluoye/BadGallery@main/image/202203181937623.png)

如果出现不合法的字节码文件，那么将会验证不通过

同时我们可以通过安装IDEA的插件，来查看我们的Class文件

![image-20200705090237078](https://cdn.jsdelivr.net/gh/senluoye/BadGallery@main/image/202203181937949.png)

安装完成后，我们编译完一个class文件后，点击view即可显示我们安装的插件来查看字节码方法了

![image-20200705090328171](https://cdn.jsdelivr.net/gh/senluoye/BadGallery@main/image/202203181938402.png)
